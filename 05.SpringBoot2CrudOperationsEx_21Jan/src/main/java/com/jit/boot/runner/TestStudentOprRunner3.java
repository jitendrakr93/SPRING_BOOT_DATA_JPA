...
@Component
public class TestStudentOprRunner3 implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * repo.deleteAll(Arrays.asList( new Student(10), new Student(12), new
		 * Student(14), new Student(16) ));
		 */
